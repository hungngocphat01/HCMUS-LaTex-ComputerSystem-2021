...
\begin{itemize}
    ...
    \item Trả về: Không.
    \item Lưu ý: chuỗi cần hiển thị phải kết thúc bằng dấu \cd{'\$'}.
\end{itemize}
\begin{minted}[]{asm}
str db "Hello world$"
... 
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \cd{100 dup(?)}: chuỗi ``thực sự'' mà hệ điều hành sẽ lưu dữ liệu đã đọc được vào đây. Giống như khai báo \cd{char str[100]};
    \end{itemize}
